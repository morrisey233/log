...
local function loadDatabase()
    ...
    print("[FishIT] 📊 Loading Epic+ fish database...")
    ...
    for _, mod in ipairs(items:GetChildren()) do
        if mod:IsA("ModuleScript") then
            ...
            if ok and data and data.Data then
                ...
                if name and tier and tier >= 4 and tier <= 7 then
                    local weightData = {}
                    if data.Weight then
    ...
    print(string.format("[FishIT] ✅ Loaded %d Epic+ fish", loadedCount))
...
print("[FishIT] ========================================")
print("[FishIT] 🎣 FISH IT LOGGER V9.0")
...
print(string.format("[FishIT] ✓ Database: %d Epic+ fish loaded", loadedCount))
print(string.format("[FishIT] ✓ Thumbnails: %d fish (%d%% coverage)", thumbnailCount, coveragePercent))
print("[FishIT] ✓ Filter: EPIC, LEGENDARY, MYTHIC, SECRET")
...
sendWebhook(
    ...
    "**v9.0 - Optimized & Real-time!**\n🚀 Event-driven, no loops\n✨ Smart mutation detection\n🟣 Epic • 🟡 Legendary • 🔴 Mythic • 🟦 SECRET",
    {
        {name = "📊 Database", value = tostring(loadedCount) .. " Epic+ fish", inline = true},
        {name = "🎯 Filter", value = "Tier 4-7 Only", inline = true},
...
print("[FishIT] ========================================")
print("[FishIT] ✅ READY! Monitoring Epic+ catches...")
print("[FishIT] ========================================")
